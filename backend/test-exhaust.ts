...
// PrismaService extends PrismaClient so we can just cast it
const gameService = new GameService(prisma as any);
...
async function main() {
  ...
  if (!hasRepeat) console.log('SUCCESS: No immediate back-to-back repeats.');
}
