    ...
    <div className="mx-auto max-w-7xl px-6 py-10">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Link
          ...
          className="group relative flex flex-col items-center justify-center gap-4 rounded-2xl border border-white/10 bg-slate-900/50 p-8 text-center transition hover:border-amber-500/50 hover:bg-slate-800/50"
        >
          <div className="rounded-full bg-amber-500/10 p-4 text-amber-400 group-hover:bg-amber-500/20 group-hover:text-amber-300 transition-colors">
            <svg
              className="h-8 w-8"
              fill="none"
              stroke="currentColor"
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-400">Review reported answers</p>
          </div>
        </Link>
      </div>
    </div>
